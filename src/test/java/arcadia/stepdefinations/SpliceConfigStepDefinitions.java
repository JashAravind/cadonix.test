...
public class SpliceConfigStepDefinitions {
    ...
    @Then("{string} component with billtype {string} is created and part number as {string}")
    public void component_with_billtype_is_created_successfully(String componentName, String componentBomBillType, String splicePartNumber) throws InterruptedException, SQLException, ClassNotFoundException {
    ...
    public void addSpliceDetailsToCreatedPhysicalSplice() throws InterruptedException, AWTException {
        spliceConfigPage.addSpliceDetailsToCreatedPhysicalSplice();
    }
    ...
    public void verifyAbleToViewUpdatePhysicalSpliceConfigurationPopup() throws InterruptedException {
        spliceConfigPage.verifyAbleToViewUpdatePhysicalSpliceConfigurationPopup();
    }
    ...
    public void verifyAbleToSuggestCreatedSplicePartnumber() throws InterruptedException {
        Thread.sleep(3000);
        spliceConfigPage.verifyAbleToSuggestCreatedSplicePartNumber();
    }
    ...
    public void verifySuggestedSplicePartnumberHasBeenUpdatedInHarnessDrawing() {
        spliceConfigPage.verifySuggestedSplicePartNumberHasBeenUpdatedInHarnessDrawing();
    }

    @Then("verify able to suggest created splice partnumber and heat shrink")
    public void verifyAbleToSuggestCreatedSplicePartNumberAndHeatShrink() throws JsonProcessingException, InterruptedException {
        spliceConfigPage.verifyAbleToSuggestCreatedSplicePartNumberAndHeatShrink();
        spliceConfigPage.calculate();
    }

    @And("Gather bundle diameter of the bundles")
    public void gatherBundleDiameterOfTheBundles() throws InterruptedException {
        spliceConfigPage.getBundleDiameter();
    }
}
