...
public enum EndPoint {
    ...
    AutomationCompanyProfile("/index.lp?app=generaledit&profilecode=quickstart"),
    BUNDLEDEFAULTDISPLAY("/index.lp?app=generaledit&appoption=3&section=Bundle%20Default%20Display&mainsection=Harness&profilecode=quickstart");
